...
class GameState(object):
    ...
    def deepCopy( self ):
        ...
        state.logs_file = self.logs_file
        return state
...
def readCommand( argv ):
    ...
    parser.add_option('-r', '--archivo', type='string', dest='archivo',
                      help=default('File to save training data instances'), default='file.arff')
    ...
    global file 
    file = options.archivo
    create_logs_file(file)
    return args
...
def create_logs_file(path):
   ...
   @ATTRIBUTE legal_actions_N {True,False}
   @ATTRIBUTE legal_actions_S {True,False}
   @ATTRIBUTE legal_actions_E {True,False}   
   @ATTRIBUTE legal_actions_W {True,False}   
   @ATTRIBUTE direction {North,South,West,East,Stop}
   @ATTRIBUTE number_ghosts NUMERIC
   @ATTRIBUTE number_living_ghosts NUMERIC
   @ATTRIBUTE mov_ver NUMERIC
   @ATTRIBUTE mov_hor NUMERIC
   @ATTRIBUTE min_distancia_norte NUMERIC
   @ATTRIBUTE min_distancia_sur NUMERIC
   @ATTRIBUTE min_distancia_oeste NUMERIC
   @ATTRIBUTE min_distancia_este NUMERIC
   @ATTRIBUTE vision_SW {True, False, Ghost}
   @ATTRIBUTE vision_W {True, False, Ghost}
   @ATTRIBUTE vision_NW {True, False, Ghost}
   @ATTRIBUTE vision_S {True, False, Ghost}
   @ATTRIBUTE vision_N {True, False, Ghost}
   @ATTRIBUTE vision_SE {True, False, Ghost}
   @ATTRIBUTE vision_E {True, False, Ghost}
   @ATTRIBUTE vision_NE {True, False, Ghost}
   @ATTRIBUTE distancia_pared_norte NUMERIC
   @ATTRIBUTE distancia_pared_sur NUMERIC
   @ATTRIBUTE distancia_pared_este NUMERIC
   @ATTRIBUTE distancia_pared_oeste NUMERIC
   @ATTRIBUTE num_ghost_N NUMERIC
   @ATTRIBUTE num_ghost_S NUMERIC
   @ATTRIBUTE num_ghost_W NUMERIC
   @ATTRIBUTE num_ghost_E NUMERIC
   @ATTRIBUTE num_ghost_ori_N NUMERIC
   @ATTRIBUTE num_ghost_ori_S NUMERIC
   @ATTRIBUTE num_ghost_ori_W NUMERIC
   @ATTRIBUTE num_ghost_ori_E NUMERIC
   @ATTRIBUTE direccion_fantasma_N {North,South,West,East,Stop,None}
   @ATTRIBUTE direccion_fantasma_S {North,South,West,East,Stop,None}
   @ATTRIBUTE direccion_fantasma_W {North,South,West,East,Stop,None}
   @ATTRIBUTE direccion_fantasma_E {North,South,West,East,Stop,None}
   @ATTRIBUTE direccion_fantasma_cercano {North,South,West,East,Stop}   
   @ATTRIBUTE distancia_fantasma_cercano NUMERIC
   @ATTRIBUTE pac_dots NUMERIC
   @ATTRIBUTE nearest_food NUMERIC
   @ATTRIBUTE SCORE NUMERIC
   @ATTRIBUTE action {North,South,West,East,Stop}
